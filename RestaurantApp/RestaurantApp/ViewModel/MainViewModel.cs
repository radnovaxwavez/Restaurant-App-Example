...
namespace RestaurantApp.ViewModel
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public List<Pick> Picks { get; set; }
                                                                                       //PushAsync() goes to a new page
        public ICommand OrderCommand => new Command(() => Application.Current.MainPage.Navigation.PushAsync(new OrderPage())); //Vanilla navigation
